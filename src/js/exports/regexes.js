...
digit = /\d/,
number = /^-?\d+$/,
capitalLetter = /[A-ZА-Я]/,
specialSymbol = /[^A-Za-z 0-9]/,
phoneNumber = /\+7 \(\d{3}\) \d{3}-\d\d-\d\d/,
limitInQuery = /&limit=[^&]+/,
offsetInQuery = /&offset=[^&]+/;

export { email, digit, number, capitalLetter, specialSymbol, phoneNumber, limitInQuery, offsetInQuery }